...
# pm2 start ./client_search_analytics.py --interpreter /usr/bin/python3

consumer = KafkaConsumer('lumenconcept.trending',
                         group_id='search_persistence',
